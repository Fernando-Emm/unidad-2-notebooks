...
# ╔═╡ 4a50ac93-d897-4820-a53c-ba4d9c64ad73
arte_de_pixeles = [RGB(1, 1, 1)  RGB(1, 1, 1)  RGB(0.93, 0, 0)  RGB(0.93, 0, 0)  RGB(0.93, 0, 0)  RGB(0.93, 0, 0)  RGB(1, 1, 1)  RGB(1, 1, 1)
 RGB(1, 1, 1)  RGB(0.93, 0, 0)  RGB(0.93, 0, 0)  RGB(0.93, 0, 0)  RGB(0.93, 0, 0)  RGB(0.93, 0, 0)  RGB(0.93, 0, 0)  RGB(0.93, 0, 0)
 RGB(1, 1, 1)  RGB(0.55, 0.27, 0.07)  RGB(0.55, 0.27, 0.07)  RGB(1, 0.87, 0.68)  RGB(1, 0.87, 0.68)  RGB(0, 0, 0.)  RGB(1, 0.87, 0.68)  RGB(1, 1, 1)
 RGB(0.55, 0.27, 0.07)  RGB(1, 0.87, 0.68)  RGB(0.55, 0.27, 0.07)  RGB(1, 0.87, 0.68)  RGB(1, 0.87, 0.68)  RGB(0, 0, 0)  RGB(1, 0.87, 0.68)  RGB(1, 0.87, 0.68)
 RGB(0.55, 0.27, 0.07)  RGB(1, 0.87, 0.68)  RGB(0.55, 0.27, 0.07)  RGB(0.55, 0.27, 0.07)  RGB(1, 0.87, 0.68)  RGB(1, 0.87, 0.68)  RGB(0.55, 0.27, 0.07)  RGB(1, 1, 1)
 RGB(0.55, 0.27, 0.07)  RGB(0.55, 0.27, 0.07)  RGB(1, 0.87, 0.68)  RGB(1, 0.87, 0.68)  RGB(1, 0.87, 0.68)  RGB(0.55, 0.27, 0.07)  RGB(0.55, 0.27, 0.07)  RGB(0.55, 0.27, 0.07)
 RGB(1, 1, 1)  RGB(1, 0.87, 0.68)  RGB(1, 0.87, 0.68)  RGB(1, 0.87, 0.68)  RGB(1, 0.87, 0.68)  RGB(1, 0.87, 0.68)  RGB(1, 0.87, 0.68)  RGB(1, 1, 1)
 RGB(0, 0, 0.8)  RGB(0, 0.0, 0.8)  RGB(0, 0, 0.8)  RGB(0.93, 0, 0)  RGB(0, 0, 0.8)  RGB(0, 0, 0.8)  RGB(1, 1, 1)  RGB(1, 1, 1)]

# ╔═╡ 1ecd8c71-3c92-47b1-aa49-baee3d373a99
